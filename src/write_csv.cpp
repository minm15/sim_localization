...
class GroundTruthRecorder : public rclcpp::Node {
  public:
    GroundTruthRecorder() : Node("ground_truth_recorder") {
        ...
        sub_ = this->create_subscription<nav_msgs::msg::Odometry>(
            "/ground_truth", 10, std::bind(&GroundTruthRecorder::odomCallback, this, std::placeholders::_1));
  ...
  private:
    void odomCallback(const nav_msgs::msg::Odometry::SharedPtr msg) {
        ...
        csv_ << std::fixed << std::setprecision(9) << t << "," << x << "," << y << "," << z << "," << roll << ","
             << pitch << "," << yaw << "\n";
    }
